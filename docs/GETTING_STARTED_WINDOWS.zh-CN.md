...
[English](GETTING_STARTED_WINDOWS.md) | **简体中文**
...
2. 看 ComfyUI 自己的控制台；
3. 运行 `doctor`；
4. 再查 [Troubleshooting](TROUBLESHOOTING.zh-CN.md)。
...
- 工作流识别与 Configurator 2.0：[WORKFLOWS.zh-CN.md](WORKFLOWS.zh-CN.md)
- 常见问题：[TROUBLESHOOTING.zh-CN.md](TROUBLESHOOTING.zh-CN.md)
